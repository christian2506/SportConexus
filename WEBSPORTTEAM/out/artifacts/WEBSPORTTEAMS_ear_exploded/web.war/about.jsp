			...
			<div class="agileinfo_about_grids">
				<div class="col-md-8 agileinfo_about_grid_left">	
					<div class="wthree_about_grid">
						<h3>Bienvenidos a <span>Sport Connexus</span></h3>
						<p>SportConnexus te facilita la reservacion de espacios deportivos mediante nuestra plataforma web
							que cuenta con una gran cantidad de espacios deportivos en Lima listos para ser rentados, con diversos horarios
							accesibles a estudiantes, universitarios, padres de familia, en SportConnexus sabemos que cada uno nuestros clientes tiene diferentes rutinas y horarios en los que pueden realizar actividades deportivas. </p>


						<p></p>
						<h4><span>Olvidate de la molesta documentacion gracias a SportConnexus</span> Caracteristicas</h4>
						<ul>
							<li><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>Registro de espacios deportivos</li>
							<li><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>Filtra tu espacio deportivo segun tu preferencia</li>
							<li><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>Participa de eventos organizados por la comunidad</li>
							<li><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>Participa de los torneos </li>
							<li><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i> Medios de pago con tarjeta de Credito/Debito </li>
						</ul>
					</div>
				</div>
...
<!-- features -->
	<div class="features">
		<div class="container">
			<h3 class="agile_head agile_head1">Caracteristicas</h3>
			<p class="w3_agile_para w3_agile_para1"></p>
			<div class="w3_agileits_features_grids">
				<div class="col-md-4 w3_agileits_features_grid">
					<div class="agileits_w3layouts_features_grid">
						...
						<div class="col-xs-8 agileits_w3layouts_features_gridr">
							<h4>Comunicacion Interactiva</h4>
							<p></p>
						</div>
						<div class="clearfix"> </div>
					</div>
				...
				<div class="col-md-4 w3_agileits_features_grid">
					<div class="agileits_w3layouts_features_grid">
						...
						<div class="col-xs-8 agileits_w3layouts_features_gridr">
							<h4>Mantenimiento de espacios deportivos</h4>
							<p></p>
						</div>
						<div class="clearfix"> </div>
					</div>
...
<!-- team -->
	<div class="services">
		<div class="container">
			<h3 class="agile_head">Nuestro Equipo</h3>
			...
			<div class="w3layouts_team_grids">	
				<div class="col-md-3 w3layouts_team_grid">
					<div class="w3l_team_grd">
						...
						<div class="w3_team_grid">
							<h4>Christian Huaynate Frias</h4>
							<h5></h5>
							<p></p>
							<ul class="title">
								<li><a href="https://www.facebook.com/christianjhonnatan.huaynatefrias" class="w3_agile_facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
				...
				<div class="col-md-3 w3layouts_team_grid">
					<div class="w3l_team_grd">
						...
						<div class="w3_team_grid">
							<h4>Accent Amayo Rabanal</h4>
							<h5></h5>
							<p></p>
							<ul class="title">
								<li><a href="https://www.facebook.com/accent.amayorabanal.1" class="w3_agile_facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
								<li><a href="#" class="agile_twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
							</ul>
						</div>
					</div>
				...
				<div class="col-md-3 w3layouts_team_grid">
					<div class="w3l_team_grd">
						...
						<div class="w3_team_grid">
							...
							<p></p>
							<ul class="title">
								<li><a href="https://www.facebook.com/erick.PMM?fref=ts" class="w3_agile_facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
								<li><a href="#" class="agile_twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
							</ul>
						</div>
					</div>
